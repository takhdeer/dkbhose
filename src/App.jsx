...
export default function App() {
  ...
  // Styles are defined as JavaScript objects these were made by chatgpt
  // Prompt: "Create a modern centered box style with shadow for a React app"
  const containerStyle = {
    height: "100vh",
    display: "flex",
    justifyContent: "center",
    alignItems: "center",
    backgroundColor: "#557cbb",
    fontFamily: "Arial",
  };
